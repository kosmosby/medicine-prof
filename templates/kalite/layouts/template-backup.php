...
<head>
    <div style="color: #666666; font-family: Verdana, Geneva, sans-serif; font-size:12px; cursor: pointer; font-weight: bold;width: 170px; height: 30px; background-color: #fff; position: fixed; z-index: 10000; border-top-left-radius: 5px; border-top-right-radius: 5px; bottom: 0px; right: 200px;" onclick="location.href='/videoconsultant?medicine-prof'">
