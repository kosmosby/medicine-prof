...
// force module style
if (in_array($module->position, array('absolute', 'socialbar', 'breadcrumbs', 'logo', 'tel', 'egitim_alani', 'banner', 'search', 'debug'))) {
	$style = 'raw';
	$showtitle = 0;
}
if (in_array($module->position, array('headerbar', 'header_login', 'toolbar-r' ,'toolbar-l', 'footer'))) {
	$style = '';
	$showtitle = 0;
}
...
if ($module->menu) {
	...
	// set menu style
	if ($renderer == 'dropline') {
		$module->menu_style = 'menu-dropline';
