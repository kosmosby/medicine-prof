...
<?php if ($type == 'logout') : ?>
	...
	<form class="short style" action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post">
        ...
        <div>
            <div class="button" style="float: left; padding-right: 5px;">
                <button value="Страница обучения" name="Страница обучения" onclick="javascript:document.location.href='/index.php?option=com_flexpaper&amp;view=membersarea&amp;Itemid=201'; return false;">Страница обучения</button>
            </div>
