...
(function(g){var x,y="",G=Math.PI,E=G/2,q="Touch"in window,I={backward:["tl","bl"],forward:["tr","br"],all:["tl","bl","tr","br"]},P=["single","double"],Q={page:1,gradients:!0,duration:600,acceleration:!0,display:"double",cornerDragging:!0,when:null},H=q?{start:"touchstart",move:"touchmove",end:"touchend"}:{start:"mousedown",move:"mousemove",end:"mouseup"},R={folding:null,corners:"forward",cornerSize:100,gradients:!0,duration:600,acceleration:!0},J={"0":{top:0,left:0,right:"auto",bottom:"auto"},1:{top:0,
right:0,left:"auto",bottom:"auto"}},l=function(a,b,c,d){return{css:{position:"absolute",top:a,left:b,overflow:d||"hidden","z-index":c||"auto"}}},L=function(a,b,c,d,e){var f=1-e,K=f*f*f,i=e*e*e;return j(Math.round(K*a.x+3*e*f*f*b.x+3*e*e*f*c.x+i*d.x),Math.round(K*a.y+3*e*f*f*b.y+3*e*e*f*c.y+i*d.y))},j=function(a,b){return{x:a,y:b}},s=function(a,b,c){return x&&c?" translate3d("+a+"px,"+b+"px, 0px) ":" translate("+a+"px, "+b+"px) "},t=function(a){return" rotate("+a+"deg) "},n=function(a,b){return Object.prototype.hasOwnProperty.call(b,
a)},S=function(){for(var a=["Moz","Webkit","Khtml","O","ms"],b=a.length,c="";b--;)a[b]+"Transform"in document.body.style&&(c="-"+a[b].toLowerCase()+"-");return c},M=function(a,b,c,d,e){var f,i=[];if("-webkit-"==y){for(f=0;f<e;f++)i.push("color-stop("+d[f][0]+", "+d[f][1]+")");a.css({"background-image":"-webkit-gradient(linear, "+b.x+"% "+b.y+"%,  "+c.x+"% "+c.y+"%, "+i.join(",")+" )"})}else{var b={x:b.x/100*a.width(),y:b.y/100*a.height()},c={x:c.x/100*a.width(),y:c.y/100*a.height()},g=c.x-b.x;f=c.y-
b.y;var h=Math.atan2(f,g),z=h-Math.PI/2,z=Math.abs(a.width()*Math.sin(z))+Math.abs(a.height()*Math.cos(z)),g=Math.sqrt(f*f+g*g),c=j(c.x<b.x?a.width():0,c.y<b.y?a.height():0),o=Math.tan(h);f=-1/o;o=(f*c.x-c.y-o*b.x+b.y)/(f-o);c=f*o-f*c.x+c.y;b=Math.sqrt(Math.pow(o-b.x,2)+Math.pow(c-b.y,2));for(f=0;f<e;f++)i.push(" "+d[f][1]+" "+100*(b+g*d[f][0])/z+"%");a.css({"background-image":y+"linear-gradient("+-h+"rad,"+i.join(",")+")"})}},N="ontouchstart"in window?{down:"touchstart",move:"touchmove",up:"touchend",
over:"touchstart",out:"touchend"}:{down:"mousedown",move:"mousemove",up:"mouseup",over:"mouseover",out:"mouseout"},h={init:function(a){void 0===x&&(x="WebKitCSSMatrix"in window||"MozPerspective"in document.body.style,y=S());var b,c=this.data(),d=this.children(),a=g.extend({width:this.width(),height:this.height()},Q,a);c.opts=a;c.pageObjs={};c.pages={};c.pageWrap={};c.pagePlace={};c.pageMv=[];c.totalPages=a.pages||0;if(a.when)for(b in a.when)n(b,a.when)&&this.bind(b,a.when[b]);this.css({position:"relative",
width:a.width,height:a.height});this.turn("display",a.display);x&&!q&&a.acceleration&&this.transform(s(0,0,!0));for(b=0;b<d.length;b++)this.turn("addPage",d[b],b+1);this.turn("page",a.page);I=g.extend({},I,a.corners);c.eventHandlers={move:function(a){for(var b in c.pages)n(b,c.pages)&&i._eventMove.call(c.pages[b],a)},end:function(a){for(var b in c.pages)n(b,c.pages)&&i._eventEnd.call(c.pages[b],a)},start:function(a){for(var b in c.pages)if(n(b,c.pages)&&!1===i._eventStart.call(c.pages[b],a))return!1}};
g(this).bind(H.start,c.eventHandlers.start);a.cornerDragging?g(document).bind(H.move,c.eventHandlers.move).bind(H.end,c.eventHandlers.end):g(document).bind(H.end,c.eventHandlers.end);c.done=!0;return this},addPage:function(a,b){var c=!1,d=this.data(),e=d.totalPages+1;if(b)if(b==e)b=e,c=!0;else{if(b>e)throw Error('It is impossible to add the page "'+b+'", the maximum value is: "'+e+'"');}else b=e,c=!0;if(1<=b&&b<=e){d.done&&this.turn("stop");b in d.pageObjs&&h._movePages.call(this,b,1);if(c)d.totalPages=
e;d.pageObjs[b]=g(a).addClass("turn-page p"+b);h._addPage.call(this,b);d.done&&this.turn("update");h._removeFromDOM.call(this)}return this},_addPage:function(a){var b=this.data(),c=b.pageObjs[a];if(c)if(h._necessPage.call(this,a)){if(!b.pageWrap[a]){var d="double"==b.display?this.width()/2:this.width(),e=this.height();c.css({width:d,height:e});b.pagePlace[a]=a;b.pageWrap[a]=g("<div/>",{id:"turn-page-wrapper-"+a,"class":"turn-page-wrapper",page:a,css:{position:"absolute",overflow:"hidden",width:d,
height:e}}).css(J["double"==b.display?a%2:0]);this.append(b.pageWrap[a]);b.pageObjs[a].appendTo(b.pageWrap[a])}(!a||1==h._setPageLoc.call(this,a))&&h._makeFlip.call(this,a)}else b.pagePlace[a]=0,b.pageObjs[a]&&b.pageObjs[a].detach()},hasPage:function(a){return a in this.data().pageObjs},destroy:function(){var a=this,b=this.data();b.destroying=!0;jQuery.each("end,first,flip,last,pressed,released,start,turning,turned,zooming,missing".split(","),function(b,d){a.unbind(d)});this.parent().unbind("start",
b.eventHandlers.start);for(jQuery(document).unbind(N.move,b.eventHandlers.move).unbind(N.up,b.eventHandlers.end);0!==b.totalPages;)this.turn("removePage",b.totalPages);b.fparent&&b.fparent.remove();b.shadow&&b.shadow.remove();this.removeData();b=null;return this},_makeFlip:function(a){var b=this.data();if(!b.pages[a]&&b.pagePlace[a]==a){var c="single"==b.display,d=a%2;b.pages[a]=b.pageObjs[a].css({width:c?this.width():this.width()/2,height:this.height()}).flip({page:a,next:c&&a===b.totalPages?a-1:
d||c?a+1:a-1,turn:this,duration:b.opts.duration,acceleration:b.opts.acceleration,corners:c?"all":d?"forward":"backward",backGradient:b.opts.gradients,frontGradient:b.opts.gradients,cornerDragging:b.opts.cornerDragging}).flip("disable",b.disabled).bind("pressed",h._pressed).bind("released",h._released).bind("start",h._start).bind("end",h._end).bind("flip",h._flip)}return b.pages[a]},_makeRange:function(a){var b;this.data();var c=this.turn("range");if(c)for(b=c[0];b<=c[1];b++)h._addPage.call(this,b);
a&&a()},range:function(a){var b,c,d=this.data(),a=a||d.tpage||d.page,e=h._view.call(this,a);if(!(1>a||a>d.totalPages))return e[1]=e[1]||e[0],1<=e[0]&&e[1]<=d.totalPages?(a=Math.floor(9),d.totalPages-e[1]>e[0]?(b=Math.min(e[0]-1,a),c=2*a-b):(c=Math.min(d.totalPages-e[1],a),b=2*a-c)):c=b=19,[Math.max(1,e[0]-b),Math.min(d.totalPages,e[1]+c)]},_necessPage:function(a){if(0===a)return!0;var b=this.turn("range");return a>=b[0]&&a<=b[1]},_removeFromDOM:function(){var a,b=this.data();for(a in b.pageWrap)n(a,
...
c||b.page==d.totalPages&&!c?a.preventDefault():c?(b.next=b.next<b.page?b.next:b.page-1,b.force=!0):b.next=b.next>b.page?b.next:b.page+1;h._addMotionPage.call(this)}},_end:function(a,b){var c=g(this).data().f.opts,d=c.turn,e=d.data();a.stopPropagation();if(b||e.tpage){if(e.tpage==c.next||e.tpage==c.page)delete e.tpage,h._fitPage.call(d,e.tpage||c.next,!0)}else d.turn("update")},_pressed:function(){var a,b=g(this).data().f,c=b.opts.turn.data().pages;for(a in c)a!=b.opts.page&&c[a].flip("disable",!0);
return b.time=(new Date).getTime()},_released:function(a,b){var c=g(this),d=c.data().f;a.stopPropagation();if(200>(new Date).getTime()-d.time||0>b.x||b.x>g(this).width())a.preventDefault(),d.opts.turn.data().tpage=d.opts.next,d.opts.turn.turn("update"),g(c).flip("turnPage")},_flip:function(){var a=g(this).data().f.opts;a.turn.trigger("turn",[a.next])},calculateZ:function(a){var b,c,d,e,f=this,i=this.data();b=this.turn("view");var g=b[0]||b[1],h={pageZ:{},partZ:{},pageV:{}},j=function(a){a=f.turn("view",
a);a[0]&&(h.pageV[a[0]]=!0);a[1]&&(h.pageV[a[1]]=!0)};for(b=0;b<a.length;b++)c=a[b],d=i.pages[c].data().f.opts.next,e=i.pagePlace[c],j(c),j(d),c=i.pagePlace[d]==d?d:c,h.pageZ[c]=i.totalPages-Math.abs(g-c),h.partZ[e]=2*i.totalPages+Math.abs(g-c);return h},update:function(){var a,b=this.data();if(b.pageMv.length&&0!==b.pageMv[0]){var c=this.turn("calculateZ",b.pageMv);this.turn("view",b.tpage);for(a in b.pageWrap)n(a,b.pageWrap)&&(b.pageWrap[a].css({display:c.pageV[a]?"":"none","z-index":c.pageZ[a]||
0}),b.pages[a]&&(b.pages[a].flip("z",c.partZ[a]||null),c.pageV[a]&&b.pages[a].flip("resize"),b.tpage&&b.pages[a].flip("disable",!0)))}else for(a in b.pageWrap)n(a,b.pageWrap)&&(c=h._setPageLoc.call(this,a),b.pages[a]&&b.pages[a].flip("disable",b.disabled||1!=c).flip("z",null))},_setPageLoc:function(a){var b=this.data(),c=this.turn("view");if(a==c[0]||a==c[1])return b.pageWrap[a].css({"z-index":b.totalPages,display:""}),1;if("single"==b.display&&a==c[0]+1||"double"==b.display&&a==c[0]-2||a==c[1]+2)return b.pageWrap[a].css({"z-index":b.totalPages-
1,display:""}),2;b.pageWrap[a].css({"z-index":0,display:"none"});return 0}},i={init:function(a){if(a.gradients)a.frontGradient=!0,a.backGradient=!0;this.data({f:{}});this.flip("options",a);i._addPageWrapper.call(this);return this},setData:function(a){var b=this.data();b.f=g.extend(b.f,a);return this},options:function(a){var b=this.data().f;return a?(i.setData.call(this,{opts:g.extend({},b.opts||R,a)}),this):b.opts},z:function(a){var b=this.data().f;b.opts["z-index"]=a;b.fwrapper.css({"z-index":a||
parseInt(b.parent.css("z-index"),10)||0});return this},_cAllowed:function(){return I[this.data().f.opts.corners]||this.data().f.opts.corners},_cornerActivated:function(a){if(void 0===a.originalEvent)return!1;var a=q?a.originalEvent.touches:[a],b=this.data().f,c=b.parent.offset(),d=this.width(),e=this.height(),a={x:Math.max(0,a[0].pageX-c.left),y:Math.max(0,a[0].pageY-c.top)},b=b.opts.cornerSize,c=i._cAllowed.call(this);if(0>=a.x||0>=a.y||a.x>=d||a.y>=e)return!1;if(a.y<b)a.corner="t";else if(a.y>=
e-b)a.corner="b";else return!1;if(a.x<=b)a.corner+="l";else if(a.x>=d-b)a.corner+="r";else return!1;(d=-1==g.inArray(a.corner,c)?!1:a)&&this.trigger("cornerActivated");return d},_c:function(a,b){b=b||0;return{tl:j(b,b),tr:j(this.width()-b,b),bl:j(b,this.height()-b),br:j(this.width()-b,this.height()-b)}[a]},_c2:function(a){return{tl:j(2*this.width(),0),tr:j(-this.width(),0),bl:j(2*this.width(),this.height()),br:j(-this.width(),this.height())}[a]},_foldingPage:function(){var a=this.data().f.opts;if(a.folding)return a.folding;
if(a.turn){var b=a.turn.data();return"single"==b.display?b.pageObjs[a.next]?b.pageObjs[0]:null:b.pageObjs[a.next]}},_backGradient:function(){var a=this.data().f,b=a.opts.turn;if((b=a.opts.backGradient&&(!b||"single"==b.data().display||2!=a.opts.page&&a.opts.page!=b.data().totalPages-1))&&!a.bshadow)a.bshadow=g("<div/>",l(0,0,1)).css({position:"",width:this.width(),height:this.height()}).appendTo(a.parent);return b},resize:function(a){var b=this.data().f,c=this.width(),d=this.height(),e=Math.round(Math.sqrt(Math.pow(c,
2)+Math.pow(d,2)));a&&(b.wrapper.css({width:e,height:e}),b.fwrapper.css({width:e,height:e}).children(":first-child").css({width:c,height:d}),b.fpage.css({width:d,height:c}),b.opts.frontGradient&&b.ashadow.css({width:d,height:c}),i._backGradient.call(this)&&b.bshadow.css({width:c,height:d}));b.parent.is(":visible")&&(b.fwrapper.css({top:b.parent.offset().top,left:b.parent.offset().left}),b.opts.turn&&b.fparent.css({top:-b.opts.turn.offset().top,left:-b.opts.turn.offset().left}));this.flip("z",b.opts["z-index"])},
_addPageWrapper:function(){var a=this.data().f,b=this.parent();if(!a.wrapper){this.css("left");this.css("top");var c=this.width(),d=this.height();Math.round(Math.sqrt(Math.pow(c,2)+Math.pow(d,2)));a.parent=b;a.fparent=a.opts.turn?a.opts.turn.data().fparent:g("#turn-fwrappers");if(!a.fparent)c=g("<div/>",{css:{"pointer-events":"none"}}).hide(),c.data().flips=0,a.opts.turn?(c.css(l(-a.opts.turn.offset().top,-a.opts.turn.offset().left,"auto","visible").css).appendTo(a.opts.turn),a.opts.turn.data().fparent=
c):c.css(l(0,0,"auto","visible").css).attr("id","turn-fwrappers").appendTo(g("body")),a.fparent=c;this.css({position:"absolute",top:0,left:0,bottom:"auto",right:"auto"});a.wrapper=g("<div/>",l(0,0,this.css("z-index"))).appendTo(b).prepend(this);a.fwrapper=g("<div/>",l(b.offset().top,b.offset().left)).hide().appendTo(a.fparent);a.fpage=g("<div/>",{css:{cursor:"default"}}).appendTo(g("<div/>",l(0,0,0,"visible")).appendTo(a.fwrapper));if(a.opts.frontGradient)a.ashadow=g("<div/>",l(0,0,1)).appendTo(a.fpage);
i.setData.call(this,a);i.resize.call(this,!0)}},_fold:function(a){var b=this,c=0,d=0,e,f,g,h,v,z,o=j(0,0),n=j(0,0),k=j(0,0),r=this.width(),u=this.height(),l=i._foldingPage.call(this);Math.tan(d);var p=this.data().f,w=p.opts.acceleration,y=p.wrapper.height(),q=i._c.call(this,a.corner),D="t"==a.corner.substr(0,1),B="l"==a.corner.substr(1,1),F=function(){var m=j(q.x?q.x-a.x:a.x,q.y?q.y-a.y:a.y),C=Math.atan2(m.y,m.x),A;d=E-C;c=180*(d/G);A=j(B?r-m.x/2:a.x+m.x/2,m.y/2);var l=d-Math.atan2(A.y,A.x),l=Math.max(0,
Math.sin(l)*Math.sqrt(Math.pow(A.x,2)+Math.pow(A.y,2)));k=j(l*Math.sin(d),l*Math.cos(d));if(d>E&&(k.x+=Math.abs(k.y*Math.tan(C)),k.y=0,Math.round(k.x*Math.tan(G-d))<u)){a.y=Math.sqrt(Math.pow(u,2)+2*A.x*m.x);if(D)a.y=u-a.y;return F()}if(d>E){m=G-d;C=y-u/Math.sin(m);o=j(Math.round(C*Math.cos(m)),Math.round(C*Math.sin(m)));if(B)o.x=-o.x;if(D)o.y=-o.y}e=Math.round(k.y/Math.tan(d)+k.x);m=r-e;C=m*Math.cos(2*d);A=m*Math.sin(2*d);n=j(Math.round(B?m-C:e+C),Math.round(D?A:u-A));v=m*Math.sin(d);m=i._c2.call(b,
a.corner);m=Math.sqrt(Math.pow(m.x-a.x,2)+Math.pow(m.y-a.y,2));z=m<r?m/r:1;if(p.opts.frontGradient){h=100<v?(v-100)/v:0;f=j(100*(v*Math.sin(E-d)/u),100*(v*Math.cos(E-d)/r));if(D)f.y=100-f.y;if(B)f.x=100-f.x}if(i._backGradient.call(b)){g=j(100*(v*Math.sin(d)/r),100*(v*Math.cos(d)/u));if(!B)g.x=100-g.x;if(!D)g.y=100-g.y}k.x=Math.round(k.x);k.y=Math.round(k.y);return!0},x=function(a,c,e,k){var l=["0","auto"],v=(r-y)*e[0]/100,q=(u-y)*e[1]/100,c={left:l[c[0]],top:l[c[1]],right:l[c[2]],bottom:l[c[3]]},
l=90!=k&&-90!=k?B?-1:1:0,e=e[0]+"% "+e[1]+"%";b.css(c).transform(t(k)+s(a.x+l,a.y,w),e);p.fpage.parent().css(c);p.fpage.css({"box-shadow":String.format("rgba(0, 0, 0, {0}) 0px 0px 20px",0.25<h?h:0.25)});p.wrapper.transform(s(-a.x+v-l,-a.y+q,w)+t(-k),e);p.fwrapper.transform(s(-a.x+o.x+v,-a.y+o.y+q,w)+t(-k),e);p.fpage.parent().transform(t(k)+s(a.x+n.x-o.x,a.y+n.y-o.y,w),e);p.opts.frontGradient&&M(p.ashadow,j(B?100:0,D?100:0),j(f.x,f.y),[[h,"rgba(0,0,0,0)"],[0.8*(1-h)+h,"rgba(0,0,0,"+0.2*z+")"],[1,"rgba(255,255,255,"+
0.2*z+")"]],3,d);i._backGradient.call(b)&&M(p.bshadow,j(B?0:100,D?0:100),j(g.x,g.y),[[0.8,"rgba(0,0,0,0)"],[1,"rgba(0,0,0,"+0.3*z+")"],[1,"rgba(0,0,0,0)"]],3)};switch(a.corner){case "tl":a.x=Math.max(a.x,1);F();x(k,[1,0,0,1],[100,0],c);p.fpage.transform(s(-u,-r,w)+t(90-2*c),"100% 100%");l.transform(t(90)+s(0,-u,w),"0% 0%");break;case "tr":a.x=Math.min(a.x,r-1);F();x(j(-k.x,k.y),[0,0,0,1],[0,0],-c);p.fpage.transform(s(0,-r,w)+t(-90+2*c),"0% 100%");l.transform(t(270)+s(-r,0,w),"0% 0%");break;case "bl":a.x=
Math.max(a.x,1);F();x(j(k.x,-k.y),[1,1,0,0],[100,100],-c);p.fpage.transform(s(-u,0,w)+t(-90+2*c),"100% 0%");l.transform(t(270)+s(-r,0,w),"0% 0%");break;case "br":a.x=Math.min(a.x,r-1),F(),x(j(-k.x,-k.y),[0,1,1,0],[0,100],c),p.fpage.transform(t(90-2*c),"0% 0%"),l.transform(t(90)+s(0,-u,w),"0% 0%")}p.point=a},_moveFoldingPage:function(a){var b=this.data().f,c=i._foldingPage.call(this);if(c)if(a){if(!b.fpage.children()[b.ashadow?"1":"0"])i.setData.call(this,{backParent:c.parent()}),b.fpage.prepend(c)}else b.backParent&&
b.backParent.prepend(c)},_showFoldedPage:function(a,b){var c=i._foldingPage.call(this),d=this.data(),e=d.f;if(!e.point||e.point.corner!=a.corner){var f=g.Event("start");this.trigger(f,[e.opts,a.corner]);if(f.isDefaultPrevented())return!1}if(c){if(b){var h=this,c=e.point&&e.point.corner==a.corner?e.point:i._c.call(this,a.corner,1);this.animatef({from:[c.x,c.y],to:[a.x,a.y],duration:500,frame:function(b){a.x=Math.round(b[0]);a.y=Math.round(b[1]);i._fold.call(h,a)}})}else i._fold.call(this,a),d.effect&&
...
this.data().f;if(b.point){b.hoveringCorner=!1;var c=this,d=b.point,e=function(){b.point=null;c.flip("hide");c.trigger("end",[!1])};if(a){var f=i._c.call(this,d.corner),a="t"==d.corner.substr(0,1)?Math.min(0,d.y-f.y)/2:Math.max(0,d.y-f.y)/2,g=j(d.x,d.y+a),h=j(f.x,f.y-a);this.animatef({from:0,to:1,frame:function(a){a=L(d,g,h,f,a);d.x=a.x;d.y=a.y;i._fold.call(c,d)},complete:e,duration:800,hiding:!0})}else this.animatef(!1),e()}},turnPage:function(a){var b=this,c=this.data().f,a={corner:c.corner?c.corner.corner:
a||i._cAllowed.call(this)[0]},d=c.point||i._c.call(this,a.corner,c.opts.turn?c.opts.turn.data().opts.elevation:0),e=i._c2.call(this,a.corner);this.trigger("flip").animatef({from:0,to:1,frame:function(c){c=L(d,d,e,e,c);a.x=c.x;a.y=c.y;i._showFoldedPage.call(b,a)},complete:function(){b.trigger("end",[!0])},duration:c.opts.duration,turning:!0});c.corner=null},moving:function(){return"effect"in this.data()},isTurning:function(){return this.flip("moving")&&this.data().effect.turning},_eventStart:function(a){var b=
this.data().f;if(!b.disabled&&!this.flip("isTurning")){b.corner=i._cornerActivated.call(this,a);if(b.corner&&i._foldingPage.call(this,b.corner))return i._moveFoldingPage.call(this,!0),this.trigger("pressed",[b.point]),!1;b.corner=null}},_eventMove:function(a){var b=this.data().f;if(!b.disabled&&b.opts.cornerDragging)if(a=q?a.originalEvent.touches:[a],b.corner&&!this.flip("isTurning")){var c=b.parent.offset();b.corner.x=a[0].pageX-c.left;b.corner.y=a[0].pageY-c.top;i._showFoldedPage.call(this,b.corner)}else if(!this.data().effect&&
this.is(":visible"))(a=i._cornerActivated.call(this,a[0]))&&!this.flip("isTurning")?(c=i._c.call(this,a.corner,b.opts.cornerSize/2),a.x=c.x,a.y=c.y,b.hoveringCorner=!0,i._showFoldedPage.call(this,a,!0)):i.hideFoldedPage.call(this,!0)},_eventEnd:function(){var a=this.data().f;if(!a.disabled&&a.point){var b=g.Event("released");this.trigger(b,[a.point]);b.isDefaultPrevented()||i.hideFoldedPage.call(this,!0)}a.corner=null},disable:function(a){i.setData.call(this,{disabled:a});return this}},O=function(a,
b,c){if(!c[0]||"object"==typeof c[0])return b.init.apply(a,c);if(b[c[0]]&&"_"!=c[0].toString().substr(0,1))return b[c[0]].apply(a,Array.prototype.slice.call(c,1));throw c[0]+" is an invalid value";};g.extend(g.fn,{flip:function(a,b){return O(this,i,arguments)},turn:function(a){return O(this,h,arguments)},transform:function(a,b){var c={};b&&(c[y+"transform-origin"]=b);c[y+"transform"]=a;return this.css(c)},animatef:function(a){var b=this.data();b.effect&&clearInterval(b.effect.handle);if(a){if(!a.to.length)a.to=
[a.to];if(!a.from.length)a.from=[a.from];if(!a.easing)a.easing=function(a,b,c,d,e){return d*Math.sqrt(1-(b=b/e-1)*b)+c};var c,d=[],e=a.to.length,f=this,g=a.fps||30,i=-g,h=function(){var c,h=[];i=Math.min(a.duration,i+g);for(c=0;c<e;c++)h.push(a.easing(1,i,a.from[c],d[c],a.duration));a.frame(1==e?h[0]:h);i==a.duration&&(clearInterval(b.effect.handle),delete b.effect,f.data(b),a.complete&&a.complete())};for(c=0;c<e;c++)d.push(a.to[c]-a.from[c]);b.effect=a;b.effect.handle=setInterval(h,g);this.data(b);
h()}else delete b.effect}});g.isTouch=q})(jQuery);
