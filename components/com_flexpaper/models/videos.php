 ...
 * @since		1.6
 */
class flexpaperModelVideos extends JModelLegacy
{
...
//         ";
        ...
        $query = "SELECT b.id, d.title, b.vmProductID as testid, c.id as results_id, c.passed, a.test_id as tid, d.id as course_id

        FROM

        #__flexpaper_quiz as a, #__lms_tests as b

        LEFT JOIN #__lms_results as c ON c.tid = b.id AND c.userid = ".$user->id." , #__osemsc_acl as d
