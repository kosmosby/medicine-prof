...
class paypal_class {
   ...
   function submit_paypal_post($paypal_processing_page) {
...
//      echo "</center>\n";
      echo $paypal_processing_page;
      echo "<form method=\"post\" name=\"dmp_order_form\" ";
      echo "action=\"".$this->paypal_url."\">\n";
      foreach ($this->fields as $name => $value) {
         echo "<input type=\"hidden\" name=\"$name\" value=\"$value\"/>\n";
      }
      //echo "<center><input type=\"submit\" value=\"Click Here\"></center>\n";
	  echo "<input type=\"hidden\" name=\"cbt\" value=\"" . _DMP_RETURNTOMERCHANTTEXT ."\"/>";      
      echo "</form>";
//      echo "</body></html>\n";
