	...
	<li>
		<div class="file-item">
			...
			<div class="file-actions file-row">
				<span class="publish btn btn-default btn-xs" data-iconpublish="fa fa-check" data-iconunpublish="fa fa-close">
...
<script id="changelog-template" type="text/x-handlebars-template">
	<li>
		<div class="changelog-item">
			<div class="changelog-item-inner">
				<span class="move"><i class="fa fa-ellipsis-v"></i></span>
				<div class="row">
					...
					<div class="changelog-date col-md-5">
						<div class="input-append" >
							<input type="text" title="" class="input-medium" name="changelogs[{{key}}][date]" id="{{calenderid}}" value="{{nowdate}}" size="25" />
							<span class="add-on fa fa-calendar" id="{{calenderid}}_img"></span>
						</div>
					</div>
					<div class="changelog-actions col-md-3">
						<span class="publish btn btn-default btn-xs" data-iconunpublish="fa fa-close" data-iconpublish="fa fa-check">
							<i class="fa fa-check"></i> <?php echo JText::_('COM_JUDOWNLOAD_PUBLISH'); ?>
						</span>
						<input type="hidden" class="changelog-published-value" value="1" name="changelogs[{{key}}][published]" />

						<span class="btn btn-default btn-xs remove" data-iconunremove="fa fa-undo" data-iconremove="fa fa-trash-o">
							<i class="fa fa-trash-o"></i> <?php echo JText::_('COM_JUDOWNLOAD_DELETE'); ?>
						</span>
				...
				<div class="row">
					<div class="changelog-description col-md-12">
						<textarea placeholder="<?php echo JText::_('COM_JUDOWNLOAD_DESCRIPTION', 'Description'); ?>" rows="3" cols="50" name="changelogs[{{key}}][description]"></textarea></div>
				</div>
			</div>
		</div>
...
<div id="judl-container" class="jubootstrap component judl-container view-form judl-form">
	<form action="<?php echo JRoute::_('index.php?option=com_judownload&layout=edit&id=' . (int) $this->item->id); ?>"
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-footer">
						<button id="noConfirmChangeCat" class="btn btn-default"><?php echo JText::_('COM_JUDOWNLOAD_CLOSE'); ?></button>
						<button id="confirmChangeCat" class="btn btn-default btn-primary"><?php echo JText::_('COM_JUDOWNLOAD_CONFIRM_AND_CHANGE'); ?></button>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="width-60 fltlft">
			...
			echo JHtml::_('tabs.panel', JText::_('COM_JUDOWNLOAD_GALLERY_TAB'), 'gallery');
            ...
            {
                echo JHtml::_('tabs.panel', JText::_('COM_JUDOWNLOAD_OTHERS_TAB'), 'others');
