...
<div id="judl-container"
     class="jubootstrap component judl-container view-category category-<?php echo $this->category->id; ?> <?php echo isset($this->tl_catid) ? 'tlcat-id-' . $this->tl_catid : ""; ?> <?php echo $this->category->class_sfx; ?> <?php echo $this->pageclass_sfx; ?>">
