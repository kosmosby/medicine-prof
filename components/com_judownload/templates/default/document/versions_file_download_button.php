	...
	if ($this->item->params->get('valid-password'))
	{
		...
		)
		{
			...
			<a href="<?php echo $fileDownloadLink; ?>" title="<?php echo $downloadFileTitle; ?>"
			   role="button"
			   class="btn btn-default btn-xs file-active-license hasTooltip" data-toggle="modal">
		...
		else
		{
			?>
			<a href="<?php echo $fileDownloadLink; ?>" title="<?php echo $downloadFileTitle; ?>"
			   class="btn btn-default btn-xs judl-accept-download hasTooltip"
...
else
{
	if (isset($this->item->error_msg))
	{
		...
		{
			?>
			<a href="<?php echo $fileDownloadLink; ?>" class="btn btn-default btn-xs"
		...
		{
			?>
			<a href="#judl-rule-msg" class="btn btn-default btn-xs"
