	...
	if ($this->item->params->get('valid-password'))
	{
		...
		)
		{
			...
			<a href="<?php echo $documentDownloadLink; ?>" title="<?php echo $downloadFileTitle; ?>"
			   role="button"
			   class="btn btn-default btn-sm file-active-license hasTooltip" data-toggle="modal">
		...
		else
		{
			?>
			<a href="<?php echo $documentDownloadLink; ?>" title="<?php echo $downloadFileTitle; ?>"
			   class="btn btn-default btn-sm judl-accept-download hasTooltip"
...
else
{
	if (isset($this->item->error_msg))
	{
		...
		{
			?>
			<a href="<?php echo $documentDownloadLink; ?>" class="btn btn-default btn-sm"
		...
		{
			?>
			<a href="#judl-rule-msg" class="btn btn-default btn-sm"
