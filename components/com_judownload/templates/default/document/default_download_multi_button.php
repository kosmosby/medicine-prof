				...
				if (isset($this->item->fields['external_link']) && $this->item->fields['external_link']->value != '')
				{
					...
					)
					{
						...
						<a href="<?php echo $this->item->download_link; ?>"
						   class="btn btn-default external" title="<?php echo JText::_('COM_JUDOWNLOAD_DOWNLOAD_SELECTED_FILES'); ?>" data-toggle="modal">
					...
					else
					{
						?>
						<a href="<?php echo $this->item->download_link; ?>"
						   id="btn-download-<?php echo $this->item->id; ?>" class="btn btn-default judl-btn-download judl-accept-download"
				...
				else
				{
					...
					)
					{
						...
						<a href="#judl-document-license" id="judl-count-files"
						   class="btn btn-default confirm-license judl-download-multi-files" title="<?php echo JText::_('COM_JUDOWNLOAD_DOWNLOAD_SELECTED_FILES'); ?>" data-toggle="modal">
							<?php echo JText::_('COM_JUDOWNLOAD_DOWNLOAD'); ?>
						</a>
					<?php
					}
	...
	else
	{
		...
		<div class="error-msg-container">
			...
			if (isset($this->item->error_msg))
			{
				...
				{
					?>
					<a href="#" id="judl-count-files" class="btn btn-default judl-download-multi-files" title="<?php echo JText::_('COM_JUDOWNLOAD_DOWNLOAD_SELECTED_FILES'); ?>">
						<?php echo JText::_('COM_JUDOWNLOAD_DOWNLOAD'); ?>
					</a>
				<?php
				}
				...
				{
					?>
					<a href="#judl-rule-msg" class="btn btn-default" data-toggle="modal" title="<?php echo JText::_('COM_JUDOWNLOAD_DOWNLOAD_SELECTED_FILES'); ?>">
						<?php echo JText::_('COM_JUDOWNLOAD_DOWNLOAD'); ?>
					</a>
				<?php
				}
