		...
		<div class="pull-left">
			...
			<div class="dashboard-actions">
				<a href="<?php echo $linkCreateDocument ?>"
				   class="btn btn-default btn-sm"><?php echo JText::_('COM_JUDOWNLOAD_ADD_DOCUMENT'); ?></a>
				<a href="<?php echo $linkUserProfile ?>"
				   class="btn btn-default btn-sm"><?php echo JText::_('COM_JUDOWNLOAD_EDIT_PROFILE'); ?></a>
			</div>
		</div>
	</div>
<?php
