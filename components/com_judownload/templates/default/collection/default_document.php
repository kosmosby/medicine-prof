...
$item_class_arr[] = $this->view_mode == 2 ? "col-md-" . $this->document_bootstrap_columns[$this->col_counter - 1] : "col-md-12";
...
?>
	<div class="<?php echo $item_class; ?>" data-list-class="col-md-12" data-grid-class="col-md-<?php echo $doc_grid_col; ?>">
	<?php
	...
	<div class="doc-actions pull-right">
		<div class="pull-right">
			...
			if ($this->params->get('show_report_btn_in_listview', 1) && ($this->item->params->get('access-report')))
			{
				...
				echo '<a href="' . $this->item->report_link . '" title="' . JText::_('COM_JUDOWNLOAD_REPORT') . '" class="hasTooltip report-task btn btn-default"><i class="fa fa-warning"></i></a>';
				echo '</span>';
			}
			?>
		</div>
