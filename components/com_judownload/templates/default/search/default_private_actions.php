				...
				<div class="modal-content">
					...
					<div class="modal-footer">
						<button id="judl-edit-state-accept-<?php echo $this->item->id; ?>"
						        class="btn btn-default btn-primary judl-edit-state-accept"><?php echo JText::_("COM_JUDOWNLOAD_CHANGE_STATE"); ?>
						</button>
				...
				<div class="modal-content">
					...
					<div class="modal-footer">
						<button id="judl-delete-accept-<?php echo $this->item->id; ?>"
						        class="btn btn-default btn-primary judl-delete-accept"><?php echo JText::_("COM_JUDOWNLOAD_DELETE"); ?>
						</button>
						<button class="btn btn-default" data-dismiss="modal" aria-hidden="true">
							<?php echo JText::_("COM_JUDOWNLOAD_CANCEL"); ?>
						</button>
