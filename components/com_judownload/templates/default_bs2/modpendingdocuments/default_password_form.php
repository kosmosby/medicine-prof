...
<div id="judl-enter-password" class="judl-enter-password modal hide fade" tabindex="-1" role="dialog"
	...
	<form name="judl-submit-password-form" onsubmit="return false;" id="judl-submit-password-form"
		...
		<div class="modal-footer">
			<a href="#" id="judl-submit-password" class="btn btn-primary judl-submit-password">
