	...
	<div class="sort-pagination row-fluid clearfix">
		...
		if ($this->allow_user_select_view_mode)
		{
			...
			<?php
				...
				?>
				<div class="judl-display btn-group hidden-phone">
					<span class="btn judl-list <?php echo $list_selected; ?>" data-view="judl-view-list"
					   title="<?php echo JText::_('COM_JUDOWNLOAD_LIST_VIEW'); ?>"><i class="fa fa-th-list"></i></span>
					<span class="btn judl-grid <?php echo $grid_selected; ?>" data-view="judl-view-grid"
		...
		if ($this->params->get('show_header_sort', 1) || $this->params->get('show_pagination', 1))
		{
			...
			<div class="span<?php echo $sortPaginationSpan[1]; ?>">
				<div class="pull-right">
					...
					{
						?>
						<div class="judl-filter-document pull-left">
							<select name="filter" class="inputbox" onchange="this.form.submit()">
								<option value=""><?php echo JText::_('COM_JUDOWNLOAD_FILTER_DOCUMENT'); ?></option>
