...
?>
<div id="judl-container" class="jubootstrap component judl-container judl-form">
	<form
		...
		if(!$this->item->global)
		{
			echo JHtml::_('tabs.panel', JText::_('COM_JUDOWNLOAD_COLLECTION_DETAILS'), 'collection-details');
		...
		echo JHtml::_('tabs.panel', JText::_('COM_JUDOWNLOAD_DOCUMENTS'), 'documents');
		?>
		<h4 class="text-right">
		...
		<div class="collection-search-docs">
			...
			<button type="submit" class="btn" id="add-doc-to-collection"><?php echo JText::_("COM_JUDOWNLOAD_ADD_DOCUMENT"); ?></button>
		</div>
