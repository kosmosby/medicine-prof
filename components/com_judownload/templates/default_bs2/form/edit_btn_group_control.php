...
if ($this->approvalForm)
{
	...
	<div class="judl-submit-buttons">
		<button type="button" class="btn btn-primary" onclick="Joomla.submitbutton('modpendingdocument.save')">
			<i class="fa fa-save"></i> <?php echo JText::_('COM_JUDOWNLOAD_SUBMIT'); ?>
		</button>
		<button type="button" class="btn" onclick="Joomla.submitbutton('modpendingdocument.cancel');">
	...
	<div class="judl-approval-container clearfix">
		<div class="judl-approval-inner">
			...
			{
				?>
				<button type="button" class="judl-previous btn btn-info"
			...
			{
				?>
				<button type="button" class="judl-next btn btn-info"
