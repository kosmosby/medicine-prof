	...
	<div id="judl-files" class="judl-files">
						...
						<div class="file-item">
							...
							<div class="file-actions file-row">
								...
								if($file['id'])
								{
									if($file_exists)
									{?>
										<a href="<?php echo JRoute::_("index.php?option=com_judownload&task=download.download&file_id=" . $file['id'] . "&" . JSession::getFormToken() . "=1"); ?>" target="_blank">
									...
									{?>
										<span class="btn btn-mini" title="<?php echo JText::_('COM_JUDOWNLOAD_MISSING_FILE'); ?>">
		                                    <i class="fa fa-warning"></i>
											<?php echo JText::_('COM_JUDOWNLOAD_MISSING'); ?>
		                                </span>
									<?php
									}?>
									<span class="btn btn-mini replace-file"><i class="fa fa-files-o"></i> <?php echo JText::_('COM_JUDOWNLOAD_REPLACE'); ?></span>
								<?php
								}?>
								<span class="<?php echo $file['published'] ? 'publish' : 'unpublish'; ?> btn btn-mini" data-iconpublish="fa fa-check" data-iconunpublish="fa fa-close">
									<?php
									if($file['published'])
									{
										?>
		...
		if(JUDownloadFrontHelperPermission::canUploadFromUrl($this->item->id))
		{
			...
			<div id="remote-file" class="remote-file">
				<div class="progress progress-striped div-active">
					<div class="bar div-percent div-percent-text" style="width: 0%;"></div>
				</div>
				<div class="clearfix">
