...
<div class="actions clearfix">
	...
	<?php if ($this->item->params->get('access-report'))
	{
		...
		<span class="action-report">
			<?php echo '<a href="' . $this->item->report_link . '" title="' . JText::_('COM_JUDOWNLOAD_REPORT') . '" class="hasTooltip report-task btn"><i class="fa fa-warning"></i></a>'; ?>
		</span>
	<?php
	}
	if ($this->item->params->get('access-contact'))
	{
		...
		<span class="action-contact">
			<?php echo '<a href="' . $this->item->contact_link . '" title="' . JText::_('COM_JUDOWNLOAD_CONTACT') . '" class="hasTooltip btn"><i class="fa fa-user"></i></a>'; ?>
		</span>
	<?php
	}
	...
	if (!$this->item->is_subscriber)
	{
		...
		<span class="action-subscribe">
			<?php echo '<a href="' . $this->item->subscribe_link . '" title="' . JText::_('COM_JUDOWNLOAD_SUBSCRIBE') . '" class="hasTooltip btn"><i class="fa fa-bookmark"></i></a>'; ?>
		</span>
	<?php
	}
	else
	{
		...
		<span class="action-unsubscribe">
			<?php echo '<a href="' . $this->item->unsubscribe_link . '" title="' . JText::_('COM_JUDOWNLOAD_UNSUBSCRIBE') . '" class="hasTooltip btn"><i class="fa fa-bookmark-o"></i></a>'; ?>
		</span>
	<?php
	} ?>
	...
	<span class="action-print">
		<?php
			...
			echo '<a class="hasTooltip btn" title="' . JText::_('COM_JUDOWNLOAD_PRINT') . '" href="' . $this->item->print_link . '" rel="nofollow" onclick="' . $onclick . '"><i class="fa fa-print" ></i></a>';
		?>
	</span>

	<span class="action-mailtofriend">
		<a href="#judl-mailtofriend"
		   title="<?php echo JText::_('COM_JUDOWNLOAD_SEND_EMAIL_TO_FRIEND'); ?>" class="hasTooltip btn"
		   data-toggle="modal"><i class="fa fa-envelope"></i></a>
	</span>

	<div class="modal hide fade" id="judl-mailtofriend" tabindex="-1" role="dialog"
	...
	<?php if ($this->collection_popup)
	{
		...
		<span class="action-addcollection">
	            <a class="hasTooltip btn judl-add-collection"
		...
		<div class="modal hide fade" id="create-collection-modal" tabindex="-1" role="dialog"
			...
			<form action="#" method="post" name="create-new-collection" class="form-horizontal">
				<div class="modal-body">
					<div class="control-group">
						<label class="control-label"><?php echo JText::_("COM_JUDOWNLOAD_FIELD_TITLE"); ?>
					...
					<div class="control-group">
						<label
							class="control-label"><?php echo JText::_("COM_JUDOWNLOAD_FIELD_DESCRIPTION"); ?></label>
					...
					<div class="control-group">
						<label
							class="control-label"><?php echo JText::_("COM_JUDOWNLOAD_FIELD_PRIVATE"); ?></label>
