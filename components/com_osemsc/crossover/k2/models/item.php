...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
				...
				else
				{
	        		...
	        		$plgParam = new JParameter($plugin->params);
					$modName = $plgParam->get('osemsccustommodule');

					$module = JModuleHelper::getModule('osecustommsclist',$modName);
					$item->video = JModuleHelper::renderModule($module);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
				...
				else
				{
	        		...
	        		$plgParam = new JParameter($plugin->params);
					$modName = $plgParam->get('osemsccustommodule');
					$module = JModuleHelper::getModule('osecustommsclist');
					$item->text = JModuleHelper::renderModule($module);
				}
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// OSE Added - OSE and Open Source Excellence is the registered trade mark of the Open Source Excellence PTE LTD.
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
