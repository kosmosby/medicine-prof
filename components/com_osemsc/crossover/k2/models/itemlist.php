...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		foreach($rows as $row)
		{
			if(in_array($row->id,$content_ids))
			{
				$row->introtext = $row->introtext.'<br /> This content is members only, please <a href="'.JROUTE::_('index.php?option=com_osemsc&view=memberships').'">subscribe a membership plan first</a>';
				$row->fulltext = '';
