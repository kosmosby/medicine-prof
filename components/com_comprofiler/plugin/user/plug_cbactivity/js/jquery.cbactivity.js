(function($) {
	...
	function bindContainer( cbactivity, init ) {
		...
		if ( init === true ) {
			...
			filterSelector.call( element.find( 'video.streamItemVideo:visible,audio.streamItemAudio:visible' ), cbactivity ).mediaelementplayer();
			...
			filterSelector.call( element.find( '.cbMoreLess' ), cbactivity ).cbmoreless( 'update' );
			filterSelector.call( element.find( 'video.streamItemVideo:visible,audio.streamItemAudio:visible' ), cbactivity ).mediaelementplayer();
		}
