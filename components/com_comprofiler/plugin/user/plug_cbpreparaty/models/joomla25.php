...
class cbpreparatyModel
{
	 ...
	 * @return null|string
	 */
	static public function getPreparatyTotal( $where, /** @noinspection PhpUnusedParameterInspection */ $viewer, $user, $plugin )
	{
		global $_CB_database;
	 ...
	 * @return Table[]
	 */
	static public function getPreparaty( $paging, $where, /** @noinspection PhpUnusedParameterInspection */ $viewer, $user, $plugin )
	{
		global $_CB_database;
