...
/**
 * Class cbconsultationsconsultationTable
...
class cbconsultationsconsultationTable extends OrderedTable
{
	...
	public $user		=	null;
	public $title		=	null;
	public $consultation_intro	=	null;
	public $consultation_full	=	null;
	...
	{
		parent::__construct( $db, '#__comprofiler_plugin_consultations', 'id' );
	}
	...
	public function check()
	{
		if ( $this->get( 'title' ) == '' ) {
			...
			return false;
		} elseif ( ! in_array( $this->get( 'category' ), cbconsultationsModel::getCategoriesList( true ) ) ) {
	...
	{
		return new cbconsultationsCategoryTable( $this->_db );
	}
}

/**
 * Class cbconsultationsCategoryTable
 * Categories Table model for CB consultations
 */
