...
class cbblogsBlogTable extends OrderedTable
{
	...
	public function bind( $array, $ignore = '', $prefix = null )
	{
		...
		if ( $bind ) {
			...
			$this->set( 'published', (int) ( ( ( ! $plugin->params->get( 'blog_approval', 0 ) ) || $isModerator ) ? Get::get( $array, 'published', $this->get( 'published' ), GetterInterface::INT ) : $this->get( 'published', $plugin->params->get( 'blog_approval', 0 ) ) ) );
