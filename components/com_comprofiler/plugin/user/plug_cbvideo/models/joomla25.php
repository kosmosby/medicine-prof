...
class cbblogsBlogTable extends OrderedTable
{
	...
	public function bind( $array, $ignore = '', $prefix = null )
	{
		...
		if ( $bind ) {
			...
			$this->set( 'state', (int) ( ( ( ! $plugin->params->get( 'blog_approval', 0 ) ) || $isModerator ) ? Get::get( $array, 'published', $this->get( 'state' ), GetterInterface::INT ) : $this->get( 'state', $plugin->params->get( 'blog_approval', 0 ) ) ) );
