...
class Hybrid_Providers_Facebook extends Hybrid_Provider_Model
{
	...
	*/
	function initialize() 
	{
		...
		$redirectUri = isset( $this->config['redirect_uri'] ) ? $this->config['redirect_uri'] : $this->endpoint;
		$trustForwarded = isset( $this->config['trustForwarded'] ) ? (bool) $this->config['trustForwarded'] : false;
		$this->api = new Facebook( ARRAY( 'appId' => $this->config["keys"]["id"], 'secret' => $this->config["keys"]["secret"], 'trustForwarded' => $trustForwarded, 'allowSignedRequest' => false, 'redirect_uri' => $redirectUri ) );
