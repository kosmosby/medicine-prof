		...
		<?php if ( $use_search ) : /* BOF search */ ?>
			...
			<span class="<?php echo $filter_container_class; ?> fc_filter_text_search fc_odd">
				...
				<?php if ($show_search_label==1) : ?>
					...
					<select class="cs-select cs-skin-border" style="font-size:14px;" name="where_s">
						<option value="1" >Искать везде</option>
						<option value="val1">По препарату</option>
						<option value="val2">По компании</option>
						<option value="val4">По АТХ коду</option>
						<option value="val5">По заболеванию</option>
					</select>
					</span>
