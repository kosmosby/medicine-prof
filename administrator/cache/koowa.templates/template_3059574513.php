            ...
            <div class="docman_grid">
                <div class="docman_grid__item two-thirds">
                    <fieldset>
                        ...
                        <div class="docman_grid">
                            <div class="control-group docman_grid__item two-thirds">
                                <label for="maximum_size" class="control-label"><?php echo $this->translate('Allow file uploads up to');?></label>
                                <div class="controls">
                                    <div class="input-group">
                                    ...
                                    <span class="help-block"><?php echo $this->translate('Your server has a maximum upload limit of <strong>{size}</strong> megabytes', array(
