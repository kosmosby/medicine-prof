                        ...
                        <tr>
                            ...
                            <td align="right">
                                <?php if ($document->storage_type == 'remote'): ?>
                                    <?php $location = $document->storage_path; ?>
                                <?php else: ?>
                                    <?php $location = $this->route('view=file&routed=1&container=docman-files&folder='.($document->storage->folder === '.' ? '' : $document->storage->folder).'&name='.$document->storage->name); ?>
                                <?php endif ?>
