...
<rss version="2.0"
   ...
   <channel>
       ...
       <item>
           ...
           <enclosure url="<?php echo $document->download_link ?>" length="<?php echo $document->size ?>" type="<?php echo $document->mimetype ?>" />
           <media:content
                url="<?php echo $document->download_link ?>"
                fileSize="<?php echo $document->size ?>"
                type="<?php echo $document->mimetype ?>"
                medium="<?php echo $document->kind ?>"
           />
           <media:title type="plain"><?php echo $this->escape($document->title); ?></media:title>
           <media:description type="html"><![CDATA[<?php echo $document->description_summary ?>]]></media:description>
           <?php if ($document->image_download_path): ?>
           <media:thumbnail url="<?php echo $document->image_download_path ?>" />
           <?php endif; ?>
