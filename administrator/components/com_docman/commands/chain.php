<?php
/**
 * @version		$Id: chain.php 4630 2012-05-07 12:46:03Z johanjanssens $
 ...
 * @package     Koowa_Command
 */
class ComDocmanCommandChain extends KObjectQueue
{
    /**
    ...
    {
        $config->append(array(
            'stack'			  =>  $this->getService('com://admin/docman.object.stack'),
