...
class osereporterViewMonthly extends osereporterView {
	function display($tpl= null) {
		JToolBarHelper :: title(JText :: _('OSE Membership™ Reporter - Monthly Statistics').' <small><small>Version '.COMPONENTVER.'</small></small>', 'logo');
