...
class JBidAdminContactController extends JControllerLegacy
{
	...
	function __construct()
	{
       ...
       JLoader::register('JBidAdminContactToolbar',$this->itempath.DS.'toolbars'.DS.'toolbar.php');
       JLoader::register('JBidAdminContactHelper',$this->itempath.DS.'helpers'.DS.'helper.php');
    ...
    function config()
    {
        ...
        $view=$this->getView('Config','html','JBidPricingViewContact');
