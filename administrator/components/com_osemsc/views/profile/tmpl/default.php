...
oseHTML :: script("administrator/components/com_osemsc/views/profile/js/js.profile.js", '1.5');
?>
<div id="oseheader">
	<div class="container">
		...
		<div class="section">
			...
			<div class="grid-title">
				<?php
				echo JText :: _('PLEASE_MANAGE_YOUR_PROFILES_HERE');
				?>
			</div>
			<div id="ose-profile-list"></div>
			</div>
	</div>
</div>
<?php
