...
class JUDownloadTableLicense extends JTable
{
	
	public function __construct(&$db)
	{
		parent::__construct('#__judownload_licenses', 'id', $db);
	}
	...
	public function store($updateNulls = false)
	{
		...
		$table = JTable::getInstance('License', 'JUDownloadTable');
		if ($table->load(array('alias' => $this->alias)) && ($table->id != $this->id || $this->id == 0))
		{
			$this->setError(JText::_('COM_JUDOWNLOAD_LICENSE_ALIAS_MUST_BE_UNIQUE'));
