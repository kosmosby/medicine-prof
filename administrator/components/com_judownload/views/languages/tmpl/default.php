...
<form
	action="<?php echo JRoute::_('index.php?option=com_judownload&view=languages'); ?>"
				...
				<tr class="row<?php echo $i % 2 ?>">
					...
					<td>
						...
						<?php if ($missing)
						{
							?>
							<br />
							<span style="color:red;">*(<?php echo JText::_('COM_JUDOWNLOAD_LANGUAGE_STRING_DOES_NOT_EXIST'); ?>)</span>
						<?php } ?>
					</td>
				</tr>
