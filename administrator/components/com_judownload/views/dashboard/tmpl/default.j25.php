...
if (JUDownloadHelper::checkGroupPermission(null, "globalconfig"))
{
	...
	<div class="cpanel">
		<div class="icon-wrapper">
			<div class="icon">
				<a href="<?php echo JRoute::_('index.php?option=com_judownload&view=globalconfig&layout=edit', false); ?>">
...
echo JHtml::_('sliders.panel', JText::_('COM_JUDOWNLOAD_TOP_5'), 'top-5-sliders');
echo JHtml::_('tabs.start', 'top-5', array('useCookie' => 1));
echo JHtml::_('tabs.panel', JText::_('COM_JUDOWNLOAD_LAST_ADDED_DOCUMENT'), 'core_fields');
?>
...
<?php
echo JHtml::_('tabs.panel', JText::_('COM_JUDOWNLOAD_LAST_ADDED_COMMENTS'), 'last-comment');
?>
<table class="adminlist table table-striped">
	<thead>
	<tr>
...
<?php
echo JHtml::_('tabs.panel', JText::_('COM_JUDOWNLOAD_LAST_DOWNLOADED_DOCUMENTS'), 'last-downloaded');
?>
<table class="adminlist table table-striped">
	<thead>
	<tr>
	...
	foreach ($lastDownloadedDocuments AS $item)
	{
		...
		<tr>
			...
			<td class="center"><?php echo $item->download_by_name ? $item->download_by_name : JText::_('COM_JUDOWNLOAD_GUEST'); ?></td>
...
<!--  Last updated -->
<?php
echo JHtml::_('tabs.panel', JText::_('COM_JUDOWNLOAD_LAST_UPDATED_DOCUMENTS'), 'last-update');
?>
<table class="adminlist table table-striped">
	<thead>
	<tr>
...
<!--  top download -->
<?php
echo JHtml::_('tabs.panel', JText::_('COM_JUDOWNLOAD_TOP_DOWNLOADED_DOCUMENTS'), 'top-download');
?>
<table class="adminlist table table-striped">
	<thead>
	<tr>
	...
	foreach ($topDownloadDocuments AS $document)
	{
		...
		<tr>
			...
			<td class="center"><?php echo $document->downloads; ?></td>
			<td class="center"><?php echo $document->created; ?></td>
			<td class="center"><?php echo $document->modified; ?></td>
			<td class="center"><?php echo JHtml::_('grid.boolean', $document->id, $document->published); ?></td>
		</tr>
	<?php
	} ?>
...
<!--  popular document -->
<?php
echo JHtml::_('tabs.panel', JText::_('COM_JUDOWNLOAD_POPULAR_DOCUMENTS'), 'popular-documents');
?>
<table class="adminlist table table-striped">
	<thead>
	<tr>
	...
	foreach ($popularDocuments AS $document)
	{
		...
		<tr>
			...
			<td class="center"><?php echo $document->hits; ?></td>
			<td class="center"><?php echo $document->created; ?></td>
			<td class="center"><?php echo $document->modified; ?></td>
			<td class="center"><?php echo JHtml::_('grid.boolean', $document->id, $document->published); ?></td>
		</tr>
...
<!--  Static -->
<?php
echo JHtml::_('tabs.panel', JText::_('COM_JUDOWNLOAD_STATISTICS'), 'static');
?>
<table class="adminlist table table-striped">
	<thead>
	<tr>
...
if(JUDLPROVERSION)
{
	...
	echo JHtml::_('sliders.panel', JText::_('COM_JUDOWNLOAD_CHART'), 'chart');
