...
class JUDownloadViewDashboard extends JUDLViewAdmin
{
	...
	{
		JToolBarHelper::title(JText::_('COM_JUDOWNLOAD_DASHBOARD'), 'dashboard');
	...
	protected function setDocument()
	{
		...
		$document->setTitle(JText::_('COM_JUDOWNLOAD_DASHBOARD'));
	}
}
