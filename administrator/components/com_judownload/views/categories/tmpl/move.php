...
<div class="jubootstrap">
	...
	<form action="<?php echo JRoute::_('index.php?option=com_judownload&view=documents'); ?>" method="post" name="adminForm" id="adminForm">
		<fieldset class="adminform">
			<legend><?php echo JText::_('COM_JUDOWNLOAD_MOVE_CATEGORIES'); ?></legend>
			<div class="span6">
				<div class="form-horizontal">
					<div class="control-group">
						<div class="control-label">
								<label><?php echo JText::_('COM_JUDOWNLOAD_MOVE_TO_CATEGORY'); ?></label>
						</div>
						<div class="controls">
							<?php
					...
					<div class="control-group">
						<div class="control-label">
							<label class="<?php echo $classTooltip; ?>" for="extra_fields" title="<?php echo JText::_('COM_JUDOWNLOAD_KEEP_EXTRA_FIELDS') . $separator . JText::_('COM_JUDOWNLOAD_KEEP_EXTRA_FIELDS_DESC'); ?>"><?php echo JText::_('COM_JUDOWNLOAD_KEEP_EXTRA_FIELDS'); ?></label>
						</div>
						<div class="controls">
			...
			<div class="span6">
				<div>
					<?php
					echo JText::plural('COM_JUDOWNLOAD_TOTAL_N_CATEGORIES_WILL_BE_MOVED', count($categories));
					?>
					<ul>
						<?php
				...
				<div class="right"><?php echo JText::_('COM_JUDOWNLOAD_MOVE_CATEGORIES_MESSAGE'); ?></div>
			</div>
