...
class JUDownloadViewTreeStructure extends JUDLViewAdmin
{
	...
	{
		JToolBarHelper::title(JText::_('COM_JUDOWNLOAD_TREE_STRUCTURE'), 'tree_overview');
		...
		{
			JToolBarHelper::deleteList('COM_JUDOWNLOAD_ARE_YOU_SURE_YOU_WANT_TO_DELETE_THESE_ITEMS', 'categories.delete');
		}
	...
	protected function setDocument()
	{
		...
		$document->setTitle(JText::_('COM_JUDOWNLOAD_TREE_STRUCTURE'));
	}
