...
<div class="jubootstrap">
	...
	<form action="<?php echo JRoute::_('index.php?option=com_judownload&view=tags'); ?>" method="post" name="adminForm" id="adminForm">
		...
		<table class="table table-striped adminlist">
			...
			<tr>
				...
				<th style="width:15%" class="nowrap">
					<?php echo JHtml::_('grid.sort', 'COM_JUDOWNLOAD_FIELD_PUBLISHED', 'published', $listDirn, $listOrder); ?>
				</th>
			...
			foreach ($this->items AS $i => $item):
				...
				<tr class="row<?php echo $i % 2; ?>">
					...
					<td class="">
						...
						{
							?>
							<a href="<?php echo JRoute::_('index.php?option=com_judownload&amp;task=tag.edit&amp;id=' . $item->id); ?>">
								<?php echo $item->title; ?>
							</a>
						<?php
						}
