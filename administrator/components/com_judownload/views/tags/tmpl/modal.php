...
?>
<form
	action="<?php echo JRoute::_('index.php?option=com_judownload&view=tags&layout=modal&tmpl=component&function='.$function.'&'.JSession::getFormToken() . '=1'); ?>"
	...
	<?php else : ?>
		<table class="table table-striped table-condensed">
			...
			<tr>
				<th>
					<?php echo JHtml::_('grid.sort', 'COM_JUDOWNLOAD_FIELD_TITLE', 'tag.title', $listDirn, $listOrder); ?>
				</th>
				...
				<th width="15%" class="center nowrap">
					<?php echo JHtml::_('grid.sort', 'COM_JUDOWNLOAD_FIELD_PUBLISHED', 'tag.published', $listDirn, $listOrder); ?>
				</th>
				<th width="5%" class="nowrap">
					<?php echo JHtml::_('grid.sort', 'COM_JUDOWNLOAD_FIELD_ID', 'tag.id', $listDirn, $listOrder); ?>
				</th>
			</tr>
			</thead>
