...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_judownload&task=tags.saveOrderAjax&tmpl=component';
...
<form
	action="<?php echo JRoute::_('index.php?option=com_judownload&view=tags'); ?>"
			...
			<table class="table table-striped adminlist" id="data-list">
				...
				<tr>
					...
					<th style="width:56%" class="nowrap">
						<?php echo JHtml::_('searchtools.sort', 'COM_JUDOWNLOAD_FIELD_TITLE', 'tag.title', $listDirn, $listOrder); ?>
					</th>
					...
					<th style="width:15%" class="nowrap">
						<?php echo JHtml::_('searchtools.sort', 'COM_JUDOWNLOAD_FIELD_PUBLISHED', 'tag.published', $listDirn, $listOrder); ?>
					</th>
					<th style="width:10%" class="nowrap">
						<?php echo JHtml::_('searchtools.sort', 'COM_JUDOWNLOAD_FIELD_ID', 'tag.id', $listDirn, $listOrder); ?>
					</th>
				</tr>
				</thead>
