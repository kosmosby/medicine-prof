...
class JUDownloadViewCriteriaGroup extends JUDLViewAdmin
{
	...
	protected function setDocument()
	{
		...
		$checkedOut = !($this->item->checked_out == 0 || $this->item->checked_out == $userId);
		$document->setTitle(JText::_('COM_JUDOWNLOAD_PAGE_' . ($checkedOut ? 'VIEW_CRITERIAGROUP' : ($isNew ? 'ADD_CRITERIAGROUP' : 'EDIT_CRITERIAGROUP'))));
