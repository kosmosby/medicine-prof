...
<fieldset class="adminform">
	<div id="related-document-list" class="related-document-list">
				...
				foreach ($this->relatedDocuments AS $document)
				{
					...
					<li id="document-<?php echo $document->id; ?>" >
						<div class="document-inner">
							...
							<?php } ?>
							<a class="rel-document-title" target="_blank" href="index.php?option=com_judownload&task=document.edit&id=<?php echo $document->id; ?>"><?php echo $document->title; ?></a>
							<a class="remove-rel-document" href="#" title="<?php echo JText::_('COM_JUDOWNLOAD_REMOVE_DOCUMENT'); ?>"><?php echo JText::_('COM_JUDOWNLOAD_REMOVE_DOCUMENT'); ?></a>
		...
		<div class="button2-left">
			<div class="blank">
				<a class="modal btn btn-mini" title="<?php echo JText::_('COM_JUDOWNLOAD_ADD_DOCUMENT'); ?>" href="<?php echo $link . '&amp;' . JSession::getFormToken(); ?>=1" rel="{handler: 'iframe', size: {x: 800, y: 450}}">
					<i class="icon-new"></i> <?php echo JText::_('COM_JUDOWNLOAD_ADD_DOCUMENT'); ?>
				</a>
			</div>
		</div>
	</div>
