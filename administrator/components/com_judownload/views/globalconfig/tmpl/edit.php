...
<div class="jubootstrap">
	...
	<form action="<?php echo JRoute::_('index.php?option=com_judownload&view=globalconfig&layout=edit'); ?>" enctype="multipart/form-data" method="post" name="adminForm" id="adminForm" class="form-validate judownload-config form-vertical">
		<?php
		...
		if ($fieldSets)
		{
			if ($this->isJoomla3x)
			{
				echo JHtml::_('bootstrap.startTabSet', 'globalconfig', array('active' => 'config-general'));
			}
			else
			{
				echo JHtml::_('tabs.start', 'judownload', array('useCookie' => 1));
			}
