...
<body bgcolor="#5a5152" text="#333333" link="#FF3366" LEFTMARGIN="0"
	...
	<div align="center">
		<table class="adminlist">
			<thead>
				<tr>
					<td width="20px"></td>
					<td width="50px" style="text-align: center"><?php echo JText::_('ID'); ?>
					</td>
					<td style="text-align: center"><?php echo JText::_('NAME'); ?></td>
	...
	?>
		...
		<button onclick="getRecording();">
			<?php echo JText::_( 'INSERT_RECORDING' ); ?>
		</button>
	</div>