		...
		if ($field->field_type=='textselect') {
		  ...
		  if ( !$select2_added )
		  {
				...
				flexicontent_html::loadFramework('select2');
                        ...
                        //$document->addStyleSheet("//cdnjs.cloudflare.com/ajax/libs/select2/4.0.0-rc.2/css/select2.min.css");
                        //$document->addScript("//cdnjs.cloudflare.com/ajax/libs/select2/4.0.0-rc.2/js/select2.min.js");
			
                        $js_ss = " <script>
        jQuery('select.sel2test').select2({
            minimumInputLength : 2
            });
        </script>
    ";
                        
                        $sel_classes  = 'sel2test';//' fcfield_textselval use_select2_lib ';
